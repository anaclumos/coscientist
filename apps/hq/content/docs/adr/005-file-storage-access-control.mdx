...
This integrates with block permissions ([ADR 6](/adr/006-permissions-embargo-model)).
...
<Cards>
  ...
  <Card title="Large Data Files" href="/adr/008-platform-boundaries-expansion">
  ...
  <Card title="File Versioning" href="/adr/002-versioning-strategy">
...
<Callout type="idea" title="Workflow Integration">
  ...
  8](/adr/008-platform-boundaries-expansion)) that produce files (like an AI
  generating a report PDF), they can use the same file storage mechanism. Our
  consistent approach means even automated content goes through the same
  pipelines.
</Callout>
