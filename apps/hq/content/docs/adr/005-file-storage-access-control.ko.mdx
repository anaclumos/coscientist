...
Block 권한([ADR 6](/adr/006-permissions-embargo-model))과 통합된다.
...
<Cards>
  ...
  <Card title="파일 버전 관리" href="/adr/002-versioning-strategy">
...
<Callout type="idea" title="워크플로우 통합">
  ...
  8](/adr/008-platform-boundaries-expansion) 참조)가 있으면 (AI가 보고서 PDF
  생성 등) 같은 파일 저장소 메커니즘을 쓸 수 있다. 일관된 접근법 덕분에 자동화된
  콘텐츠도 같은 파이프라인을 거친다.
</Callout>
