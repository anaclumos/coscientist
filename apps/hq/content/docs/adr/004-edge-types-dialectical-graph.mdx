...
Beyond linear documents, our knowledge system aims to represent a **knowledge graph** – a network of ideas and information. Blocks (from [ADR 1](/adr/001-unified-block-model)) are the nodes of this graph. We need a way to connect these nodes with various relationships.
