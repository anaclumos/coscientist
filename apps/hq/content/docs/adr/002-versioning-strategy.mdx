...
- **Conflict Resolution UX:** At the technical level, conflicts are handled by OT (rebasing). However, simultaneous edits can produce confusing results. The version history will show both edits sequentially. We might need to highlight conflicts or ensure presence indicators ([ADR 7](/adr/007-presence-cursors)) warn users when editing nearby.
...
<Cards>
  <Card title="CRDT / Offline Support" href="/adr/003-collaboration-protocol">
  ...
  <Card title="Federated Versioning" href="/adr/003-collaboration-protocol">
  ...
  <Card
    ...
    href="/adr/008-platform-boundaries-expansion"
  >
