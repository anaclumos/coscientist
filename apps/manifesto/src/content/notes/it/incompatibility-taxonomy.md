...
La tassonomia delle incompatibilità è una classificazione dei motivi per cui le fonti non sono d’accordo. Le categorie includono differenze di definizione , differenze di campionamento , differenze di metodo , deriva dell’ambito  e [non stazionarietà](./nonstationarity) (il mondo è cambiato tra gli studi).
