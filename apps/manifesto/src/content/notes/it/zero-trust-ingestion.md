...
L’acquisizione zero-trust è una difesa contro la [sbobba AI](./ai-slop) e l’[Crollo dell'Enciclopedia](./encyclopedia-meltdown). Quando l’ambiente è inondato di contenuti plausibili ma non verificati, l’unica postura sicura è richiedere una prova dell’origine e resistere alle contestazioni prima dell’accettazione.
