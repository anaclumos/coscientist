...
Correzione vs deriva è il principio economico secondo cui un sistema di conoscenza rimane sano solo se il costo di correggere gli errori resta inferiore al costo di lasciarli propagare. Quando la correzione diventa costosa , vince la deriva: gli errori persistono perché non vale la pena di correggerli.
