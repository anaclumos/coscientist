...
- [Knowledge Ark](./knowledge-ark) — repository progettati per sopravvivere al collasso

## Intuizione chiave

- [Dalla conservazione alla capacità](./from-preservation-to-capability) — il passaggio dall’archiviare al produrre comprensione

L’enciclopedia fittizia è un obiettivo di progettazione: che cosa servirebbe per costruire un sistema reale in grado di sopravvivere a un ambiente epistemico saturo di IA e di produrre comunque conoscenza autentica?
