...
انسائیکلوپیڈیا میلٹ ڈاؤن (Encyclopedia Meltdown) علم کے انہدام (knowledge-collapse) کی ایک ناکامی کی صورت (failure mode) ہے جو اُس وقت شروع ہوتی ہے جب لکھنے کا اقدام اور کنٹرول [آپریٹر](./operator) کی شعوری مداخلت کے بغیر AI کی طرف منتقل ہو جاتا ہے۔ یہ اصطلاح [Sunghyun Cho](./sunghyun-cho) کے ایک مضمون سے آئی ہے۔
