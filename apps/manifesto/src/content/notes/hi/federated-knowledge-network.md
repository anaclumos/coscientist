...
मुख्य बाध्यता [zero-trust ingestion](./zero-trust-ingestion) है: आयातित दावों के साथ [provenance](./provenance) होना चाहिए और स्थानीय [verification](./verification) से गुजरना चाहिए। संप्रभुता प्रत्येक नोड के [ऑपरेटर](./operator) के पास ही रहती है; नेटवर्क प्राधिकरण का केंद्रीकरण किए बिना पहुँच को बढ़ाता है।
