...
Dalam varian "1+4", satu manusia mengoordinasikan empat asisten AI . Intinya bukan "lebih banyak memori"; melainkan ketidaksepakatan yang terstruktur dan keterlacakan.
...
- Wajibkan asal-usul  yang dapat ditelusuri untuk klaim  dan [Provenance](./provenance)).
...
Kebulatan suara bukanlah bukti kebenaran. Model-model berbagi data pelatihan dan dapat berkonvergensi pada mode kegagalan yang berkorelasi, sehingga kesepakatan dapat mencerminkan bias bersama alih-alih [verifikasi](./verification) yang independen ). Kebulatan suara juga dapat mendorong penulisan menjadi terlalu berhati-hati  atau klaim yang paling aman dan paling umum.
