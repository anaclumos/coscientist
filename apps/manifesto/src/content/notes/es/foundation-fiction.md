...
- [Arca del conocimiento](./knowledge-ark) — repositorios diseñados para sobrevivir al colapso

## Idea clave

- [De la preservación a la capacidad](./from-preservation-to-capability) — el giro de almacenar a producir comprensión

La enciclopedia ficticia es un objetivo de diseño: ¿qué haría falta para construir un sistema real que pudiera sobrevivir en un entorno epistémico saturado de IA y aun así producir conocimiento genuino?