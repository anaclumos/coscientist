...
La capa de inferencia es la red viva y evolutiva de [afirmaciones](./claim), [ataques](./attack), [socavaciones](./undercut) y relaciones de apoyo en un [Grafo Dialéctico](./dialectical-graph). Representa el estado actual del conocimiento: qué se cree, qué se disputa y qué ha sido refutado.
