...
description: Analysepattern, das Behauptungen nach Methode statt nach Schlussfolgerung gruppiert
---

Die Kopplung von Methode und Schlussfolgerung ist ein Analysepattern, das [Behauptungen](./claim) nach der [Methode](./method) gruppiert, die sie hervorgebracht hat, statt nach der Schlussfolgerung, zu der sie gelangen. Die Einsicht dabei ist, dass unterschiedliche Schlussfolgerungen denselben Fehler teilen können und identische Schlussfolgerungen auf sehr unterschiedlichen Grundlagen beruhen können.
