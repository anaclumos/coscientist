...
Belangrijke overgangen zijn onder andere: voorlopig → betwist  wordt geregistreerd), betwist → voorwaardelijk ondersteund  te beperken of [aannames](./assumption) te verduidelijken), voorwaardelijk ondersteund → robuust , robuust → weerlegd , en elke toestand → achterhaald  de betekenis van de claim verbreekt).
