...
Bir [Diyalektik Grafik](./dialectical-graph) içinde düğümler, ham metin yerine epistemik nesneleri temsil eder. Yaygın düğüm türleri şunlardır:

- [İddia](./claim) — doğrulanabilir önermeler
- [Kapsam](./scope) — uygulanabilirlik koşulları
- [Varsayım](./assumption) — örtük öncüller
- Tanımlar — terim anlamları (zaman içinde [Tanım Kayması](./definition-drift) aracılığıyla izlenir)
