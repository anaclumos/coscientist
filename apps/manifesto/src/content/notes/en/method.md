...
In a [Dialectical Graph](./dialectical-graph), methods are nodes connected to claims and evidence ). An [undercut](./undercut) can target the method, arguing that the procedure was flawed even if the data were accurately reported.
