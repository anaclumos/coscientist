...
The deeper issue is epistemic: slop raises the background noise of the internet, inflates the cost of verification, and pushes systems toward self-referential drift. In that sense it is adjacent to both [model collapse](./model-collapse)  and [Encyclopedia Meltdown](./encyclopedia-meltdown) .
